...
const projects = [
  {
    ...
    description: 'Bridging the gap between surplus and scarcity. Secure JWT authentication, location-based distribution, and smart food posting with automated notifications.',
  ...
  },
  {
    ...
    description: 'Explainable AI with attention-based token highlighting. Gemini-assisted fact verification for contextual validation and production-ready inference.',
  ...
  },
  {
    ...
    description: 'Dynamic load balancing across equal-cost paths. Congestion detection and hotspot mitigation in simulated cloud-scale data centers.',
  ...
  },
  {
    ...
    description: 'Centralized knowledge repository for academic data. Advanced search, intelligent summarization, and role-based administration.',
